...
from src.utils.extract_CLIP_features import extract_clip_features_HF
...
def parse_args_sys(args_list=None):
    ...
    arg_parser.add_argument("--dataset", type=str, default="Toxicn_mm", help="FB or MMHS")
...
def main(args):
    ...
    Text_model = CLIPTextModel.from_pretrained(local_model_path,local_files_only=True)
    preprocess = CLIPProcessor.from_pretrained(local_model_path,local_files_only=True)
    ...
    elif args.dataset == "HarMeme" or args.dataset == "Toxicn_mm" or args.dataset == "MMHS" or args.dataset == "Propaganda" or args.dataset == "Tamil" or args.dataset == "HarmC" or args.dataset == "HarmP" or args.dataset == "MultiOFF":
